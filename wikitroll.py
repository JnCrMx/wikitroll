...
while True:
	...
	if first:
		...
		if format=="html":
			...
			print("<style>")
			print("troll { color: red; font-weight: bold; }")
			print("original { color: green; font-weight: bold; }")
			print(".tp { color: red; border: 2px solid red; padding: 5px; margin: 5px; }")
			print(".op { color: green; border: 2px solid green; padding: 5px; margin: 5px; }")
